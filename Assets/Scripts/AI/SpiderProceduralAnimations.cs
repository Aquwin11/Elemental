...
public class SpiderProceduralAnimations : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        {
            Vector2 v1 = legTargets[0].position - legTargets[1].position;
            Vector2 v2 = legTargets[2].position - legTargets[3].position;
